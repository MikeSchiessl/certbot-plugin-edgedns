...
class Authenticator(dns_common.DNSAuthenticator):
    ...
    def _validate_credentials(self):
        ...
        EDGEGRID_CREDS["account_key"] = self.credentials.conf('account_key')
...
class _EdgeDNSClient(object):
    ...
    def __init__(self, edgedns_creds):
        ...
        if EdgeRc(EDGEGRID_CREDS["edgerc_path"]).get(section, 'account_key'):
           self.http_parameters = {'accountSwitchKey': EdgeRc(EDGEGRID_CREDS["edgerc_path"]).get(section, 'account_key')}
